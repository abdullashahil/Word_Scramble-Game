...
var audioCorrect = new Audio('Correct Answer Sound Effect.mp3');
var audioWrong = new Audio('Error 404 Sound Effect.mp3');
var audioClick = new Audio('150382__orginaljun__soft-sound-plastic-button-click.mp3');
var bgAudio = new Audio('2d game OST - Background Music.mp3');
